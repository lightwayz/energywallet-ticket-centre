...
// 🔥 Extract form into its own client component so Suspense can wrap useSearchParams
    ...
    const GlowingButton = ({ children }: any) => (
        <motion.button
            ...
            className="
                ...
                w-full mt-6 tracking-wide select-none overflow-hidden
            "
        >
            <span
                className="
