...
export default function PurchaseTicket({
    ...
    useEffect(() => {
        console.log("🧾 Props received:", { eventId, eventName, price });
    }, []);
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                ...
                                className="px-6 py-3 bg-energy-orange text-energy-black font-semibold rounded-xl shadow-md hover:bg-orange-400 w-full mb-3"
                            >
                                Download Ticket PDF
                            </button>
                            <button
